...
Meeshkan works by building a stand-in, or *mock*, of the service with which you integrate.  It does this by using various sources of information, like HTTP  recordings of interactions with the production API and OpenAPI documents describing the API, to automatically create a mock service whose behavior is *close enough* to that of the original service. *Close enough* means, amongst other things:
