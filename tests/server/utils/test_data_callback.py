...
def test_request_logging():
    ...
    with RequestLoggingCallback(
        log_dir="./tests/tmp/logs",
        specs_dir="./tests/tmp/specs",
        update_mode=UpdateMode.MIXED,
    ) as data_callback:
    ...
    with RequestLoggingCallback(
        log_dir="./tests/tmp/logs", specs_dir="./tests/tmp/specs", update_mode=None
    ) as data_callback:
        data_callback.log(request, response)
