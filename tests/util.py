...
def read_recordings_as_request_response(requests_path=SAMPLE_RECORDINGS_PATH) -> List[RequestResponsePair]:
    return [RequestResponseBuilder.from_dict(reqres) for reqres in read_recordings_as_dict(requests_path)]
