...
def test_no_callback():
    ...
    response = ResponseBuilder.from_dict(dict(statusCode=200,
                        body='',
                        bodyAsJson={},
                        headers={}))
...
def test_json():
    ...
    request = RequestBuilder.from_dict(dict(method='post',
                      host='api.com',
                      pathname='/counter',
                      query={},
                      body='',
    ...
    request_set = RequestBuilder.from_dict(dict(method='post',
                          host='api.com',
                          pathname='/counter',
                          query={},
                          body='',
